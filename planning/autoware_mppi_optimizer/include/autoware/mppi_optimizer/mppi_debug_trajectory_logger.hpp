    ...
    const FirstOrderDubinsMppiCostParams & cost, const FirstOrderDubinsMppiVehicleParams & vehicle)
  {
    ...
    }
    {
      ...
      if (out) {
        ...
        out << "track_terminal_stopping_scale," << cost.track_terminal_stopping_scale << "\n";
        out << "stopping_velocity," << cost.stopping_velocity << "\n";
        ...
        out << "nominal_spline_smoothing_weight," << cost.nominal_spline_smoothing_weight << "\n";
