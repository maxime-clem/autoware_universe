...
DEFAULT_PARAMS: Dict[str, float] = {
    ...
    "track_terminal_stopping_scale": 10.0,
    ...
    "lateral_boundary_barrier_weight": 2000.0,
...
SLIDER_SPECS: List[Tuple[str, float, float]] = [
    ...
    ("track_terminal_stopping_scale", 0.0, 50.0),
    ("stopping_velocity", 0.0, 5.0),
    ...
    ("nominal_spline_smoothing_weight", 0.0, 100.0),
    ("boundary_threshold", 0.1, 5.0),
    ("lateral_boundary_soft_margin", 0.0, 2.0),
    ("lateral_boundary_barrier_weight", 0.0, 100000.0),
